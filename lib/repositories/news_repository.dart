...
class NewsRepository extends BaseNewsRepository {
  ...
  Future<List<Article>> getNews({int page}) async {
    List<Article> news = [];
    String requestUrl =
        "https://newsapi.org/v2/everything?domains=wsj.com,nytimes.com,bbc.com,buzzfeednews.com,edition.cnn.com,timesofindia.indiatimes.com,theguardian.com,washingtonpost.com,cnbc.com,ndtv.com,time.com,scmp.com&language=enpage=$page&apiKey=${apiKey}";
